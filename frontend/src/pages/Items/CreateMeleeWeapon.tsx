...
export const CreateMeleeWeapon = ({onConfirm}: IProps) => {
    ...
    return (
        <form onSubmit={onSubmit}>
            ...
            <div>
                <TextField required {...register("strengthGroup", {required: true})} id="strengthGroup"
                           label="Strength Group"
                           variant={"filled"} type={"number"}/>
            </div>
            <div>
                <TextField required {...register("damage", {required: true})} id="damage" label="Damage"
                           variant={"filled"}/>
            </div>
            <div>
                <TextField required {...register("length", {required: true})} id="length" label="Length"
                           variant={"filled"}
                           type={"number"}/>
            </div>
            <div>
                <TextField required {...register("weight", {required: true})} id="weight" label="Weight (BEP)"
                           variant={"filled"}
