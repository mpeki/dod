...
public class CharacterHelper {
  ...
  public static void deleteCharacter(WebDriver driver, String name) {
    ...
    WebElement containerDiv = namedCardSpan.findElement(By.xpath(".//ancestor::div[contains(@class, 'MuiPaper-root')][1]"));
  ...
  public static void buySkill(WebDriver driver, String skillCatagory, String skillName, String fvValue){
    WebElement addSkillButton = driver.findElement(By.xpath("//div[span[text()='Base Skill Points']]/following-sibling::button[contains(@class, 'MuiIconButton-root')]"));
    addSkillButton.click();
    WebElement filterDropdownInput = driver.findElement(By.xpath("//div[text()='Filter skills:']/following-sibling::div//input[@role='combobox']"));
    filterDropdownInput.click();
    filterDropdownInput.sendKeys(skillCatagory);
    filterDropdownInput.sendKeys(Keys.ENTER);
    WebElement skillDropdownInput = driver.findElement(By.xpath("//div[text()='Select a skill:']/following-sibling::div//input[@role='combobox']"));
